...
const ActiveStorageUpload = require('@CKDev/uppy-activestorage-upload')
...
```bash
yarn add https://github.com/CKDev/uppy-activestorage-upload
or
npm install https://github.com/CKDev/uppy-activestorage-upload --save
```
